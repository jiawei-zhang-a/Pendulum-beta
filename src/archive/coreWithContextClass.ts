...
//     }
// return r;`;
//         let r = this.parseTree(statement, variable)+';\n';
//         if(variable.parameterized)
//             piScript = entrance+"let r ="+ r+exit;
//         else
//             piScript = "return "+r;
//         return piScript;
//     }
...
//         }
//         for(let i = 26; i< 52; i++){
//             let q = new Quantity(4, 3, undefined,
//                 [NaN, NaN, NaN]);
//             q.lock();
//             this.context[i] = [[q]];
//         }
...
//
//     /**
//      * Overrides the top of the stack with the specified value.
//      * When stack is empty, write at index 0
//      */
//     put(index: number, subIndex: number, value:Number){
//         let stack = this.context[index][subIndex];
//         stack[(stack.length>0)?stack.length-1:1]=value;
//     }
//     /**
...
//             value.lock();
//         this.context[index][subIndex].push(value);
//         return value;
//     }
//     /**
...
//      */
//     pop(index: number, subIndex: number){
//         let value = this.context[index][subIndex].pop();
//         if(value instanceof Quantity) {
//             value.release();
//             value.recycle();
//         }
...
//     target: Variable;
//     evaluate: (a:Arithmetics, c:Context, p:Number[])=>Number;
//     context: Context;
...
//      */
//     evaluate: (a:Arithmetics, c:Context, p:Number[])=>Number =
//         (a:Arithmetics, c:Context, p: Number[])=>c.access(this.contextID, 0);
//     get = (rlID:number, context: Context, s = 0)=>{
...
//             case 2: return reference[1];
//             case 3: return context.access(<number>reference[1],<number>reference[2]);
//         }
//         return undefined;
//     };
//     /**
...
//         this.evaluate = function(a: Arithmetics, context: Context, parameters: Number[]){
...
//             (x,y)=>this.evalHandle.compute(pendulum.canvas.time,Number(x),Number(y)).valueOf());
//     }
//     /**
...
//                             this.context.put(tID, 0, t );
//                             this.context.put(xID, 0, param[0]);
//                             this.context.put(yID, 0, (param.length>1)?param[1]:0);
...
//                     quantity.lock();
//                 if(accessStyle){
//                     reference[2] = (a:Arithmetics,c:Context,p: Number[])=>{
//                         if(p.length===0)
//                             return quantity;
...
//                 else
//                     reference[1] = (a:Arithmetics,c:Context,p: Number[])=>{//Special dealing with func$ type
//                         if(p.length===0)
//                             return p[0];
//                         let b = (p.length === 1)? p[0]: a.rc.getQuantity(4, p.length);
//                         if(b instanceof Quantity)
...
//                                 b.data[i] = p[i];
//                             }
//                         return a.invisDot(depVar.evaluate(a, c,[]), b);
//                     }
//                 break;
//             case 3:
//                 reference[1] = contextID(depVar.name);
//                 reference[2] = 0;
//                 reference[3] = (a:Arithmetics,c:Context,p: Number[])=>{
//                     let r = c.access(<number>reference[1],<number>reference[2]);
//                     if(p.length===0)
//                         return r;
//                     let b = (p.length === 1)? p[0]: a.rc.getQuantity(4, p.length);
//                     if(b instanceof Quantity)
